...
-dontskipnonpubliclibraryclasses    #是否混淆jar包里的class
...
-keep  class * implements com.mwee.android.drivenbus.IDriver {
 @com.mwee.android.drivenbus.component.DrivenMethod *;
}
