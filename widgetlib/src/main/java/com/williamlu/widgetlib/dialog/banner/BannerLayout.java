package com.williamlu.widgetlib.dialog.banner;
...
/**
 * https://github.com/amy993/RecyclerBanner
 * 3D版折叠轮播图
 */
public class BannerLayout extends FrameLayout {
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        if (mUnselectedDrawable == null) {
            ...
            unSelectedGradientDrawable.setColor(getResources().getColor(R.color.color_e6e6e6));
            unSelectedGradientDrawable.setSize(dp2px(14), dp2px(2));
        ...
        vpLayoutParams.setMargins(dp2px(0), dp2px(0), dp2px(0), dp2px(20));
